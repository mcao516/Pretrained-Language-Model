...
TINYBERT_DIR=/home/mcao610/scratch/TinyBERT_TEST/${TASK_NAME}/similarity-256  # output directory

mkdir $TINYBERT_DIR
python /home/mcao610/Pretrained-Language-Model/TinyBERT/task_distill.py --similarity_distill \
