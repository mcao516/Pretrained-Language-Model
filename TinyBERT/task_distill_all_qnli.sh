...
TASK_NAME=QNLI
PREDICTION_EVAL_STEP=50
INTERMEDIATE_EVAL_STEP=100

for CLUSTER_NUM in 2 4 8 16 32 64
do
    ...
    GENERAL_TINYBERT_DIR=$SCRATCH/General_TinyBERT_4L_312D
    TASK_DIR=$SCRATCH/glue_data/${TASK_NAME}
    TMP_TINYBERT_DIR=$SCRATCH/TinyBERT_TEST/${TASK_NAME}/intermediate-4L-${CLUSTER_NUM}-scratch
    ...
    TMP_TINYBERT_DIR=$SCRATCH/TinyBERT_TEST/${TASK_NAME}/intermediate-4L-${CLUSTER_NUM}-scratch
    TASK_DIR=$SCRATCH/glue_data/${TASK_NAME}
    TINYBERT_DIR=$SCRATCH/TinyBERT_TEST/${TASK_NAME}/final-4L-${CLUSTER_NUM}-scratch
    ...
    GENERAL_TINYBERT_DIR=$SCRATCH/TinyBERT_TEST/${TASK_NAME}/final-4L-${CLUSTER_NUM}-scratch
    TASK_DIR=$SCRATCH/glue_data/${TASK_NAME}
    TMP_TINYBERT_DIR=$SCRATCH/TinyBERT_TEST/${TASK_NAME}/intermediate-4L-${CLASS_NUM}-seq${CLUSTER_NUM}-scratch
    ...
    TMP_TINYBERT_DIR=$SCRATCH/TinyBERT_TEST/${TASK_NAME}/intermediate-4L-${CLASS_NUM}-seq${CLUSTER_NUM}-scratch
    TASK_DIR=$SCRATCH/glue_data/${TASK_NAME}
    TINYBERT_DIR=$SCRATCH/TinyBERT_TEST/${TASK_NAME}/final-4L-${CLASS_NUM}-seq${CLUSTER_NUM}-scratch
